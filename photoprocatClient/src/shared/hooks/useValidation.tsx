...
import { selectValidationError, selectValidationErrorText } from '../../entities/navBar/model/navBarSelectors';
...
const useValidation = ({
  ...
  const onLogin = () => {
    if (validationPassword && validationEmail) {
      ...
      if (!validationEmail) {
        !validationErrorText.includes('mail') &&
          setValidationErrorText([...validationErrorText, 'mail']);
      }

      if (!validationPassword) {
        !validationErrorText.includes('password') &&
          setValidationErrorText([...validationErrorText, 'password']);
      }
