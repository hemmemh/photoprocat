...
import { addItemToBasket, addOrder, changeAmount, IBasketItem, IOrdersItemProduct, removeAll, removeItemFromBasket } from '../../../shared/https/basketApi';
import { change } from '../../../shared/https/productApi';
import { productSlice } from '../../productItem/model/ProductSlice';
...
export const buy = () => async (dispatch: AppDispatch) => {
  ...
  try {
    ...
    for (const el of basket.basketItems) {
      arr = [...arr, { [el.product._id]: el.count }];
    }
