  ...
  return (
    <div className="bottomFooter__payments payment-bottom-footer">
      <div className="payment-bottom-footer__payment">
        <img src={require('../../../shared/images/footer/payment/1.png')} alt="" />
      </div>
      <div className="payment-bottom-footer__payment">
        <img src={require('../../../shared/images/footer/payment/2.png')} alt="" />
      </div>
      <div className="payment-bottom-footer__payment">
        <img src={require('../../../shared/images/footer/payment/3.png')} alt="" />
      </div>
    </div>
  );
};
