      ...
      <div className="links-bottom-footer__left">
        <div className="links-bottom-footer__top">
          <div className="links-bottom-footer__link">
            <img
              src={require('../../../shared/images/footer/links/1.png')}
              alt=""
            />
          </div>
          <div className="links-bottom-footer__link">
            <img
              src={require('../../../shared/images/footer/links/2.png')}
              alt=""
            />
          </div>
          <div className="links-bottom-footer__link">
            <img
              src={require('../../../shared/images/footer/links/3.png')}
              alt=""
            />
          </div>
          <div className="links-bottom-footer__link">
            <img
              src={require('../../../shared/images/footer/links/4.png')}
              alt=""
            />
          </div>
          <div className="links-bottom-footer__link">
            <img
              src={require('../../../shared/images/footer/links/5.png')}
              alt=""
            />
          </div>
        </div>
