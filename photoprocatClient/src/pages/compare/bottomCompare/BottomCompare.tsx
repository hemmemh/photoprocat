import Fold from '../../../shared/UI/fold/Fold';
import { Swiper, SwiperSlide } from 'swiper/react';
import { Swiper as SwiperClass, Controller } from 'swiper';
import './bottomCompare.scss';
import { selectActiveType, selectCompare, selectFold } from '../../../entities/compareItem/model/compareSelectors';
import { selectInformations } from '../../../entities/catalog/model/catalogSelectors';
import { useAppSelector } from '../../../shared/hooks/reduxHooks';
import { IInformation } from '../../../shared/https/productApi';
